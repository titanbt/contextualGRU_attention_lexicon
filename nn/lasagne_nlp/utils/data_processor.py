...
from nn.lasagne_nlp.utils import utils as utils
...
def generate_character_data(sentences_train, sentences_dev, sentences_test, max_sent_length, char_embedd_dim=80):
    """
    ...
    def build_char_embedd_table():
        logger.info('Dimension of char embedding dim is ' + str(char_embedd_dim))
...
def load_dataset_sequence_labeling(train_path, dev_path, test_path, word_column=0, label_column=1,
                                   label_name='senti', oov='embedding', fine_tune=False, embedding="word2Vec",
                                   embedding_path=None,
                                   use_character=False):
    """
    load data from file
